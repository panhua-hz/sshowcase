...
public class NoteShow {
	...
	public NoteShow(EntNote note){
		...
		this.noteID = note.getId().toString();
	...
	public NoteShow(String noteID, String createAt, Double latitude, Double longitude, String[] tags, String message) {
		super();
		this.noteID = noteID;
		this.createAt = createAt;
